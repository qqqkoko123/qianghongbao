...
public class rg_YingYongGongJuLei {
    ...
    public static boolean rg_YingYong_ShiFouAnZhuang (android.content.Context rg_SuoZaiChuangKou5, String rg_PanDuanDeYingYongBaoMing) {
        try
        {
            android.content.pm.PackageInfo rg_ChengXuBao3;
            rg_ChengXuBao3 = (rg_SuoZaiChuangKou5.getPackageManager ().getPackageInfo(rg_PanDuanDeYingYongBaoMing, 0));
            if (rg_ChengXuBao3 == null)
            {
                return (false);
            }
            else
