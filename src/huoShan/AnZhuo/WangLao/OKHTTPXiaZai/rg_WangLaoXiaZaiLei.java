...
public class rg_WangLaoXiaZaiLei {
    ...
    public static com.lzy.okserver.download.DownloadTask rg_ChuangJianRenWu (String rg_RenWuBiaoJi21, String rg_WenJianDeZhi1, int rg_FangWenFangShi12, com.lzy.okgo.model.HttpParams rg_DiJiaoCanShu8, com.lzy.okgo.model.HttpHeaders rg_XieYiTou9, boolean rg_PinJieCanShu8, boolean rg_Multipart8, String rg_ShangChuanWenBen8, String rg_ShangChuanJSON8, byte [] rg_ShangChuanZiJie8, java.io.File rg_ShangChuanWenJian9) {
        ...
        if (rg_FangWenFangShi12 == huoShan.AnZhuo.WangLao.OKHTTPFangWen.rg_WangLaoFangWenFangShi.rg_GET1)
        {
            ...
            if (rg_XieYiTou9 != null)
                request.headers(rg_XieYiTou9);
            return com.lzy.okserver.OkDownload.request(rg_RenWuBiaoJi21, request);
        }
        else if (rg_FangWenFangShi12 == huoShan.AnZhuo.WangLao.OKHTTPFangWen.rg_WangLaoFangWenFangShi.rg_POST1)
        {
        ...
        else if (rg_FangWenFangShi12 == huoShan.AnZhuo.WangLao.OKHTTPFangWen.rg_WangLaoFangWenFangShi.rg_TRACE1)
        {
        ...
        else if (rg_FangWenFangShi12 == huoShan.AnZhuo.WangLao.OKHTTPFangWen.rg_WangLaoFangWenFangShi.rg_HEAD1)
        {
        ...
        else if (rg_FangWenFangShi12 == huoShan.AnZhuo.WangLao.OKHTTPFangWen.rg_WangLaoFangWenFangShi.rg_DELETE1)
        {
        ...
        else if (rg_FangWenFangShi12 == huoShan.AnZhuo.WangLao.OKHTTPFangWen.rg_WangLaoFangWenFangShi.rg_OPTIONS1)
        {
        ...
        else if (rg_FangWenFangShi12 == huoShan.AnZhuo.WangLao.OKHTTPFangWen.rg_WangLaoFangWenFangShi.rg_PATCH1)
        {
        ...
        else if (rg_FangWenFangShi12 == huoShan.AnZhuo.WangLao.OKHTTPFangWen.rg_WangLaoFangWenFangShi.rg_PUT1)
        {
