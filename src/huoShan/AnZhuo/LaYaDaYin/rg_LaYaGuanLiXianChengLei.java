...
class rg_LaYaGuanLiXianChengLei extends rg_LaYaFuWuXianChengJiChuLei {
    ...
    public static rg_LaYaGuanLiXianChengLei rg_ChuangJian151 (android.bluetooth.BluetoothSocket rg_Can_LaYaTaoJieZi1, rg_LaYaDaYinFuWuLei rg_LaYaDaYinFuWu1) {
    ...
    public void rg_ZhengZaiYunHang () {
        byte [] rg_HuanChongOu11 = new byte [1024];
        int rg_ZiJieChangDu = 0;
        while (true)
        {
            try
            {
                rg_ZiJieChangDu = rg_Lei_LaYaTaoJieZi2.getInputStream().read (rg_HuanChongOu11);
                byte [] rg_LinShiShuZu1;
                rg_LinShiShuZu1 = new byte [rg_ZiJieChangDu];
                System.arraycopy (rg_HuanChongOu11, 0, rg_LinShiShuZu1, 0, rg_ZiJieChangDu);
            }
