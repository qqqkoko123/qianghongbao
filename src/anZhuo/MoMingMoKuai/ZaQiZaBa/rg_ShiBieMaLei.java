...
public class rg_ShiBieMaLei {
    ...
    public static String rg_JiTong_QuShiBieMa (int rg_YaoQuDeShiBieMa, android.app.Activity rg_SuoChuChuangKou57) {
        android.telephony.TelephonyManager rg_DianHuaGuanLi;
        rg_DianHuaGuanLi = (android.telephony.TelephonyManager)rg_SuoChuChuangKou57.getSystemService (huoShan.AnZhuo.JiBen.rg_AnZhuoHuanJing.rg_DianHuaFuWu);
        if (rg_DianHuaGuanLi != null)
        {
            ...
            {
                return (huoShan.AnZhuo.SheBei.DianHuaGuanLi.rg_JiTongXinXiLei.rg_QuAnZhuoID (rg_SuoChuChuangKou57));
            }
            else
            {
                return ("");
