...
public class rg_GaoJiJianRongBianJiKuang extends huoShan.AnZhuo.JiBen.rg_BianJiKuang {
    ...
    public void rg_QiYongQingChuAnNiu (final boolean rg_XianShi42) {
        if (huoShan.AnZhuo.JiBen.rg_YingYongChengXu.sIsUiThread ()) {
            try {
                GetMaterialEditText ().setShowClearButton (rg_XianShi42);
            } catch (Exception e) { }
        } else {
    ...
    public void rg_FuDongDiShiNeiRong (final String rg_NeiRong13) {
        if (huoShan.AnZhuo.JiBen.rg_YingYongChengXu.sIsUiThread ()) {
            try {
                GetMaterialEditText ().setFloatingLabelText (rg_NeiRong13);
            } catch (Exception e) { }
        } else {
            huoShan.AnZhuo.JiBen.rg_YingYongChengXu.sRunOnUiThread (new Runnable () {
                @Override public void run () {
