...
public class rg_LaYaDaYinJiChuLei {
    ...
    protected int rg_QuanJuAnBoDongTaiJieShouQi_JieShouDaoQuanJuAnBo (huoShan.AnZhuo.JiBen.rg_QuanJuAnBoDongTaiJieShouQi rg_LaiYuanDuiXiang52, int rg_BiaoJiZhi52, android.content.BroadcastReceiver rg_JieShouQiDuiXiang1, android.content.Intent rg_QiDongXinXi21) {
        if (rg_QiDongXinXi21.getAction ().equals (huoShan.AnZhuo.SheBei.LaYaCaoZuo.rg_LaYaKuoPeiQiLei.rg_KaiShiChaZhao))
        {
            rg_KaiShiSouSuoSheBei1 ();
        }
        else if (rg_QiDongXinXi21.getAction ().equals (huoShan.AnZhuo.SheBei.LaYaCaoZuo.rg_LaYaKuoPeiQiLei.rg_ChaZhaoWanBi))
        {
            rg_SheBeiSouSuoWanBi ();
        }
        else if (rg_QiDongXinXi21.getAction ().equals ("android.bluetooth.adapter.action.STATE_CHANGED"))
        {
            rg_ZhuangTaiBeiGaiBian2 (huoShan.AnZhuo.SheBei.LaYaCaoZuo.rg_LaYaKuoPeiQiLei.rg_ZhuangTai10 (rg_LaYaKuoPeiQi));
        }
        else if (rg_QiDongXinXi21.getAction ().equals (huoShan.AnZhuo.SheBei.LaYaCaoZuo.rg_LaYaSheBeiLei.rg_BangDingZhuangTaiBianHua))
        {
            android.bluetooth.BluetoothDevice rg_LaYaSheBei;
            rg_LaYaSheBei = (android.bluetooth.BluetoothDevice)rg_QiDongXinXi21.getParcelableExtra (huoShan.AnZhuo.SheBei.LaYaCaoZuo.rg_LaYaSheBeiLei.rg_EWaiZiDuan_LaYaSheBeiDuiXiang);
        ...
        else if (rg_QiDongXinXi21.getAction ().equals (huoShan.AnZhuo.SheBei.LaYaCaoZuo.rg_LaYaSheBeiLei.rg_XinZhaoSheBei))
        {
            android.bluetooth.BluetoothDevice rg_LaYaSheBei1;
            rg_LaYaSheBei1 = (android.bluetooth.BluetoothDevice)rg_QiDongXinXi21.getParcelableExtra (huoShan.AnZhuo.SheBei.LaYaCaoZuo.rg_LaYaSheBeiLei.rg_EWaiZiDuan_LaYaSheBeiDuiXiang);
        ...
        else if (rg_QiDongXinXi21.getAction ().equals (huoShan.AnZhuo.SheBei.LaYaCaoZuo.rg_LaYaSheBeiLei.rg_QingQiuPeiDui))
        {
        }
        return (0);
    }
