...
public class rg_AnZhuoQuanXian {
    ...
    public static final String rg_FangWenZhenDongQi = "android.permission.VIBRATE";
    public static final String rg_NFCTongXun = "android.permission.NFC";
    ...
    public static final String rg_AnZhuangYingYongChengXu = "android.permission.INSTALL_PACKAGES";
    public static final String rg_QingQiuAnZhuangYingYongChengXu = "android.permission.REQUEST_INSTALL_PACKAGES";
    ...
    public static final String rg_GuaZaiWenJianJiTong = "android.permission.MOUNT_UNMOUNT_FILESYSTEMS";
    public static final String rg_SheZhiJiTongShiJian = "android.permission.SET_TIME";
    public static final String rg_SheZhiZhuoMianBiZhi = "android.permission.SET_WALLPAPER";
    ...
    public static final String rg_USBZhuJiMoShi = "android.hardware.usb.host";
    public static final String rg_USBFuJianMoShi = "android.hardware.usb.accessory";
    public static final String rg_ShiYongZhiWen = "android.permission.USE_FINGERPRINT";
    public static final String rg_YunXuShiYongGongWaiFaSheQi = "android.permission.TRANSMIT_IR";
