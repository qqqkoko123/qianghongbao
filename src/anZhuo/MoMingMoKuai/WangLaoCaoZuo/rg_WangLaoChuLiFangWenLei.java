...
public class rg_WangLaoChuLiFangWenLei {
    ...
    public static byte [] rg_WangYe_FangWen (String rg_Can_WangZhi3, int rg_Can_FangWenFangShi2, String rg_Can_DiJiaoXinXi2, String rg_Can_DiJiaoCookies2, String rg_Can_FuJiaXieYiTou2, boolean rg_Can_JinZhiChongDingXiang1, String rg_Can_YaoShangChuanDeWenJian2, String rg_Can_YaoShangChuanDeWenJianCanShuMing2, boolean rg_Can_QingQiuTiFangShiShangChuan2, String rg_Can_ShangChuanWenBen2, String rg_Can_ShangChuanJSON2, byte [] rg_Can_ShangChuanZiJie2, java.io.File rg_Can_ChunWenJianShangChuan2, boolean rg_Can_PinJieCanShuDaoWangZhi2, boolean rg_Can_ShiFouBuQuanBiYaoXieYiTou1) {
        ...
        com.lzy.okgo.model.HttpParams rg_CanShuDuiXiang19 = new com.lzy.okgo.model.HttpParams ();
        String rg_DiJiaoXinXi9;
        ...
        if (huoShan.Java.JiBen.rg_WenBenXingLei.rg_WenBenShiFouWeiKong (rg_Can_DiJiaoXinXi2) == false)
        {
            ...
            {
                rg_DiJiaoXinXi9 = anZhuo.MoMingMoKuai.JiBenShuJuLeiXing.rg_WenBenCaoZuoGongJuLei.rg_WenBen_ShanZuoBian (rg_Can_DiJiaoXinXi2, 1, true);
            }
            else
            {
                rg_DiJiaoXinXi9 = rg_Can_DiJiaoXinXi2;
            }
            String [] rg_CanShuShuZu1;
            int rg_JiCi108 = 0;
            rg_CanShuShuZu1 = anZhuo.MoMingMoKuai.JiBenShuJuLeiXing.rg_WenBenCaoZuoGongJuLei.rg_WenBen_FenGeWenBen (rg_DiJiaoXinXi9, "&", true);
            for (rg_JiCi108 = 0; rg_JiCi108 < rg_CanShuShuZu1.length; rg_JiCi108++)
            {
                String [] rg_CanShu8;
                rg_CanShu8 = anZhuo.MoMingMoKuai.JiBenShuJuLeiXing.rg_WenBenCaoZuoGongJuLei.rg_WenBen_FenGeWenBen (rg_CanShuShuZu1 [rg_JiCi108], "=", true);
                if (rg_CanShu8.length == 2)
                {
                    rg_CanShuDuiXiang19.put(rg_CanShu8 [0], rg_CanShu8 [1], false);
                }
                else if (rg_CanShu8.length == 1)
                {
                    rg_CanShuDuiXiang19.put(rg_CanShu8 [0], "", false);
                }
            }
        }
        if (huoShan.Java.JiBen.rg_WenBenXingLei.rg_WenBenShiFouWeiKong (rg_Can_YaoShangChuanDeWenJian2) == false)
        {
            if ((new java.io.File (rg_Can_YaoShangChuanDeWenJian2).exists ()) == true)
            {
                ...
                rg_CanShuDuiXiang19.put(rg_Can_YaoShangChuanDeWenJianCanShuMing2, new java.io.File (rg_Can_YaoShangChuanDeWenJian2));
            }
        }
        ...
        if (rg_Can_DiJiaoCookies2.equals ("") == false)
        {
            if (rg_Can_DiJiaoCookies2.toUpperCase ().startsWith (("Cookie".toUpperCase ()), 0))
            {
                String rg_WenBen60;
                String rg_WenBen61;
                rg_WenBen60 = anZhuo.MoMingMoKuai.JiBenShuJuLeiXing.rg_WenBenCaoZuoGongJuLei.rg_WenBen_QuZuoBian (rg_Can_DiJiaoCookies2, ":", 1, false);
                rg_WenBen61 = anZhuo.MoMingMoKuai.JiBenShuJuLeiXing.rg_WenBenCaoZuoGongJuLei.rg_WenBen_QuYouBian (rg_Can_DiJiaoCookies2, ":", 0, false);
                rg_QingQiuTou9.put(rg_WenBen60, rg_WenBen61);
            }
            else
            {
        ...
        if (huoShan.Java.JiBen.rg_WenBenXingLei.rg_WenBenShiFouWeiKong (rg_Can_FuJiaXieYiTou2) == false)
        {
            ...
            int rg_JiCi109 = 0;
            for (rg_JiCi109 = 0; rg_JiCi109 < rg_XieYiTouShuZu1.length; rg_JiCi109++)
            {
                String rg_MingZi1;
                String rg_Zhi143;
                rg_MingZi1 = anZhuo.MoMingMoKuai.JiBenShuJuLeiXing.rg_WenBenCaoZuoGongJuLei.rg_WenBen_QuZuoBian (rg_XieYiTouShuZu1 [rg_JiCi109], ":", 1, true);
                rg_Zhi143 = anZhuo.MoMingMoKuai.JiBenShuJuLeiXing.rg_WenBenCaoZuoGongJuLei.rg_WenBen_QuYouBian (rg_XieYiTouShuZu1 [rg_JiCi109], ":", 0, true);
                rg_QingQiuTou9.put(rg_MingZi1, rg_Zhi143);
            }
        }
        ...
        rg_Si_FanHuiJieGuo = rg_WangLaoFangWen1.rg_WangYeFangWen_ZiJieShuZu_TongBu (rg_Ju_LinShiWangZhi1, rg_Can_FangWenFangShi2, rg_CanShuDuiXiang19, rg_QingQiuTou9, huoShan.AnZhuo.WangLao.OKHTTPFangWen.rg_WangLaoFangWenHuanCunMoShi.rg_GenSuiQuanJuSheZhi, -1, null, rg_Can_PinJieCanShuDaoWangZhi2, rg_Can_QingQiuTiFangShiShangChuan2, rg_Can_ShangChuanWenBen2, rg_Can_ShangChuanJSON2, rg_Can_ShangChuanZiJie2, rg_Can_ChunWenJianShangChuan2);
