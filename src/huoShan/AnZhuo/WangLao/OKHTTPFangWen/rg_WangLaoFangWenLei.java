...
public class rg_WangLaoFangWenLei {
    ...
    public com.lzy.okgo.model.Response rg_WangYeFangWen_ZiJieShuZu_TongBu (String rg_WangZhi15, int rg_FangWenFangShi8, com.lzy.okgo.model.HttpParams rg_DiJiaoCanShu6, com.lzy.okgo.model.HttpHeaders rg_XieYiTou6, int rg_HuanCunMoShi8, int rg_ShiBaiChongShi6, java.lang.Object rg_BiaoJiDuiXiang6, boolean rg_PinJieCanShu6, boolean rg_Multipart6, String rg_ShangChuanWenBen6, String rg_ShangChuanJSON6, byte [] rg_ShangChuanZiJie6, java.io.File rg_ShangChuanWenJian7) {
        if (huoShan.Java.JiBen.rg_WenBenXingLei.rg_WenBenShiFouWeiKong (rg_WangZhi15))
        {
            return (null);
        }
        String contentType = rg_XieYiTou6 == null ? "" : rg_XieYiTou6.get("Content-Type");
        if (rg_FangWenFangShi8 == rg_WangLaoFangWenFangShi.rg_GET1)
        {
            com.lzy.okgo.request.GetRequest request = com.lzy.okgo.OkGo.<byte[]>get(rg_WangZhi15);
            if (rg_DiJiaoCanShu6 != null)
                request.params(rg_DiJiaoCanShu6);
            if (rg_XieYiTou6 != null)
                request.headers(rg_XieYiTou6);
        ...
        else if (rg_FangWenFangShi8 == rg_WangLaoFangWenFangShi.rg_POST1)
        {
            com.lzy.okgo.request.PostRequest request = com.lzy.okgo.OkGo.<byte[]>post(rg_WangZhi15);
            if (rg_DiJiaoCanShu6 != null)
                request.params(rg_DiJiaoCanShu6);
            if (rg_XieYiTou6 != null)
                request.headers(rg_XieYiTou6);
        ...
        else if (rg_FangWenFangShi8 == rg_WangLaoFangWenFangShi.rg_TRACE1)
        {
            com.lzy.okgo.request.TraceRequest request = com.lzy.okgo.OkGo.<byte[]>trace(rg_WangZhi15);
            if (rg_DiJiaoCanShu6 != null)
                request.params(rg_DiJiaoCanShu6);
            if (rg_XieYiTou6 != null)
                request.headers(rg_XieYiTou6);
        ...
        else if (rg_FangWenFangShi8 == rg_WangLaoFangWenFangShi.rg_HEAD1)
        {
            com.lzy.okgo.request.HeadRequest request = com.lzy.okgo.OkGo.<byte[]>head(rg_WangZhi15);
            if (rg_DiJiaoCanShu6 != null)
                request.params(rg_DiJiaoCanShu6);
            if (rg_XieYiTou6 != null)
                request.headers(rg_XieYiTou6);
        ...
        else if (rg_FangWenFangShi8 == rg_WangLaoFangWenFangShi.rg_DELETE1)
        {
            com.lzy.okgo.request.DeleteRequest request = com.lzy.okgo.OkGo.<byte[]>delete(rg_WangZhi15);
            if (rg_DiJiaoCanShu6 != null)
                request.params(rg_DiJiaoCanShu6);
            if (rg_XieYiTou6 != null)
                request.headers(rg_XieYiTou6);
        ...
        else if (rg_FangWenFangShi8 == rg_WangLaoFangWenFangShi.rg_OPTIONS1)
        {
            com.lzy.okgo.request.OptionsRequest request = com.lzy.okgo.OkGo.<byte[]>options(rg_WangZhi15);
            if (rg_DiJiaoCanShu6 != null)
                request.params(rg_DiJiaoCanShu6);
            if (rg_XieYiTou6 != null)
                request.headers(rg_XieYiTou6);
        ...
        else if (rg_FangWenFangShi8 == rg_WangLaoFangWenFangShi.rg_PATCH1)
        {
            com.lzy.okgo.request.PatchRequest request = com.lzy.okgo.OkGo.<byte[]>patch(rg_WangZhi15);
            if (rg_DiJiaoCanShu6 != null)
                request.params(rg_DiJiaoCanShu6);
            if (rg_XieYiTou6 != null)
                request.headers(rg_XieYiTou6);
        ...
        else if (rg_FangWenFangShi8 == rg_WangLaoFangWenFangShi.rg_PUT1)
        {
            com.lzy.okgo.request.PutRequest request = com.lzy.okgo.OkGo.<byte[]>put(rg_WangZhi15);
            if (rg_DiJiaoCanShu6 != null)
                request.params(rg_DiJiaoCanShu6);
            if (rg_XieYiTou6 != null)
                request.headers(rg_XieYiTou6);
