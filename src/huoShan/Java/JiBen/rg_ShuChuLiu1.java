...
public class rg_ShuChuLiu1 {
    ...
    public static boolean rg_XieChuHuanCun1 (java.io.OutputStream rg_SuoYuCaoZuoShuChuLiu1, rg_ZhuangTaiLei rg_ZhuangTaiDuiXiang32) {
        if (rg_ZhuangTaiDuiXiang32 == null || rg_ZhuangTaiDuiXiang32.rg_YiShiBai1 () == false) {
           try {
               ...
               if (rg_ZhuangTaiDuiXiang32 != null)
                   rg_ZhuangTaiDuiXiang32.rg_ZhiZhuangTai (rg_ZhuangTaiLei.rg_ShiBai2);
           }
        }
        return false;
    }
        ...
        if (rg_ZhuangTaiDuiXiang33 == null || rg_ZhuangTaiDuiXiang33.rg_YiShiBai1 () == false) {
           try {
               ...
               if (rg_ZhuangTaiDuiXiang33 != null)
                   rg_ZhuangTaiDuiXiang33.rg_ZhiZhuangTai (rg_ZhuangTaiLei.rg_ShiBai2);
           }
        }
        return false;
    }
