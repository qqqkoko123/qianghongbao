...
public class rg_ChangYongChuangKouFuJiaQingChan {
    ...
    public rg_ChangYongChuangKouFuJiaQingChan ()  { }

    public static final String rg_AnZhuo5MoBiaoTiChuangKou = "<. android:theme=\"@android:style/Theme.Material.NoActionBar\" />";
    ...
    public static final String rg_QuanMianBing = "<\\@manifest\\@application><meta-data android:name=\"android.max_aspect\" android:value=\"2.1\" /></@application>";
