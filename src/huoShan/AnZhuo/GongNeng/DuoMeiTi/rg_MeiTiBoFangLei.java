...
public class rg_MeiTiBoFangLei extends android.media.MediaPlayer {
    ...
    public static interface re_ShiPinCheCunBeiGaiBian { int dispatch (rg_MeiTiBoFangLei objSource, int nTagNumber, int rg_KuanDu188, int rg_GaoDu202); }
    ...
    public int rg_ShiPinCheCunBeiGaiBian (int rg_KuanDu188, int rg_GaoDu202) {
        ...
        return (objDispatcher != null ? objDispatcher.dispatch (this, nTagNumber, rg_KuanDu188, rg_GaoDu202) : 0);
    }
